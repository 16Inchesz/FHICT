...
#include <time.h>
#include <string.h>
/* 3rd part of Assignment 1 SD Johnson Domacasse*/
//references found on the website geekforgeeks.org/(sorting algorithm)

//swap function for bubble and quick sort.
